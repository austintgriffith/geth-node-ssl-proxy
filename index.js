...
try{
  ...
  exec('geth --http.port 48545 --http.vhosts=* --cache=4096 --maxpeers=50 --http --http.addr "0.0.0.0" --http.corsdomain "*" --http.api="db,eth,net,web3,debug,txpool" >> ./geth.log 2>&1', (err, stdout, stderr) => {
