const fs = require('fs');
const { cacheRequestLogPath } = require('../config');

function logCacheRequest(req, startTime, utcTimestamp, duration, status) {
  ...
  fs.appendFile(cacheRequestLogPath, logEntry, (err) => {
    if (err) {
...
module.exports = { logCacheRequest };